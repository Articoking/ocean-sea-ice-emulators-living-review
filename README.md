...
# Machine-Learning-Based Emulators for Ocean and Sea Ice Modelling and Prediction : a living review
...
## How to Contribute
We welcome contributions! To add a new reference or suggest an update:
1. **Fork** this repository.
2. **Edit** the relevant table in this README.
3. **Submit a pull request** with a clear description of your changes.
4. Ensure all entries are peer-reviewed or preprints (e.g., arXiv, EGUsphere) and include a DOI or stable link.
